...
*
* Target
*  - Compiler: g++ -m32 -pthread -std=c++17 -D_REENTRANT -O3
*  - Arch: x86_32
*  - OS: mingw
*/
...
#define BOTAN_VERSION_VC_REVISION "git:1df7edc8676e7e219cf3edb324aaeee7904ab22b"
